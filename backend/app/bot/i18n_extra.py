...
EXTRA_STRINGS: dict[str, dict[str, str]] = {
    ...
    "info_panel": {
        "ru": (
            "<b>ℹ️ О боте Arcana AI</b>\n"
            "<i>Твой эзотерический помощник: таро, символика, личные вопросы и мягкая рефлексия.</i>\n\n"
            "<b>Что можно делать</b>\n"
            "🔮 <b>Расклады таро</b>\n"
            "Выбери тему — любовь, деньги, карьера, выбор или совместимость — и задай вопрос своими словами.\n\n"
            "🌅 <b>Карта дня</b>\n"
            "Короткий ориентир на день: настроение, совет и на что обратить внимание.\n\n"
            "🧘 <b>Дзен</b>\n"
            "Не предсказание, а спокойный разбор состояния: что чувствуешь, где зажато, какой шаг сделать мягче.\n\n"
            "ᚠ <b>Руны и камни</b>\n"
            "Рунический ответ, подбор камней и браслета под запрос — для настроя, фокуса и символической поддержки.\n\n"
            "💬 <b>Диалог с памятью</b>\n"
            "Можно просто писать как живому наставнику. Бот учитывает профиль и важные детали прошлых разговоров.\n\n"
            "📸 <b>Фото</b>\n"
            "Пришли фото — бот предложит режим:\n"
            "• <b>аура</b>: цвет, энергетический образ и инфографика;\n"
            "• <b>ладонь</b>: линии сердца, ума, жизни и судьбы;\n"
            "• <b>свой вопрос</b>: например, «что чувствуется по фото?».\n\n"
            "<b>Полезные разделы</b>\n"
            "<pre>"
            "📜 История    сохранить прошлые расклады\n"
            "💳 Баланс     лимиты, пополнение, подписка\n"
            "🤝 Рефералка  ссылка, статистика, вывод\n"
            "⚙️ Настройки  язык, голос, профиль, память\n"
            "</pre>\n\n"
            "<b>Стоимость</b>\n"
            "На бесплатном тарифе есть месячные лимиты. После них ответы могут списываться с баланса. "
            "Фото с инфографикой — платная функция.\n\n"
            "<b>Важно</b>\n"
            "Arcana AI — развлекательный эзотерический сервис. Он не заменяет врача, психолога, юриста или финансового консультанта.\n\n"
            "📄 <a href=\"{legal_url}\">Оферта и политика конфиденциальности</a>\n"
            "💬 Если что-то не работает — нажми «Поддержка»."
        ),
        "en": (
            "<b>ℹ️ About Arcana AI</b>\n"
            "<i>Your esoteric assistant for tarot, symbolism, personal questions, and soft reflection.</i>\n\n"
            "🔮 <b>Tarot readings</b> — choose a topic and ask in your own words.\n\n"
            "🌅 <b>Daily card</b> — a short daily focus and advice.\n\n"
            "🧘 <b>Zen</b> — calm reflection without fortune-telling.\n\n"
            "ᚠ <b>Runes & stones</b> — symbolic answers, stones, and bracelet suggestions.\n\n"
            "💬 <b>Memory chat</b> — write naturally; the bot remembers important context.\n\n"
            "📸 <b>Photos</b> — aura color + infographic, palm lines, or your own photo question.\n\n"
            "<pre>"
            "History   past readings\n"
            "Balance   limits and payments\n"
            "Referrals invite link and stats\n"
            "Settings  language, voice, memory\n"
            "</pre>\n\n"
            "Arcana AI is an entertainment esoteric service, not medical, legal, or financial advice.\n\n"
            "📄 <a href=\"{legal_url}\">Terms and privacy policy</a>"
        ),
        "es": (
            "ℹ️ Sobre Arcana AI\n\n"
