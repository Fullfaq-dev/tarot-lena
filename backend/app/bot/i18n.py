...
_STRINGS: dict[str, dict[str, str]] = {
    "main_menu_text": {
        "ru": (
            ...
            "Я отвечаю в эзотерическом формате: таро, символы, руны, камни, аура, ладонь, "
            "отношения, деньги, карьера и внутреннее состояние.\n\n"
        ...
        "en": (
            ...
            "I remember your story and reply with context in mind.\n\n"
            "📸 You can send a photo — I'll read your aura or palm lines."
        ),
        "es": (
            "✨ ¿Qué hacemos ahora?\n\n"
            "Elige una sección abajo — o escríbeme como a un guía espiritual personal. "
            "Recuerdo tu historia y respondo con contexto.\n\n"
        ...
        "pt": (
            ...
            "Lembro da sua história e respondo com contexto.\n\n"
