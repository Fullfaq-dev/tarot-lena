...
PRODUCTS: dict[str, Product] = {
    "tarot_spread": Product(
        ...
        title="Расклад Таро",
        emoji="🃏",
        price_rub=Decimal("450"),
        pitch=(
            "🃏 **Расклад Таро** — 450 ₽\n\n"
            "Задай вопрос — выпадут **4 карты** с персональной интерпретацией от Леи.\n\n"
            "✔️ Итог: ясность по ситуации и конкретный совет."
        ),
        mini_hint="Напиши свой вопрос — под него выпадут 4 карты с толкованием:",
    ),
    "love": Product(
        id="love",
        title="Любовь",
